<nav x-data="{ open: false }" class="border-b border-gray-100 bg-gray-400 mt-10 h-24">
            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-30 w-auto fill-current text-gray-600" />
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('ad.create')" :active="request()->routeIs('ad.create')">
                {{ __('Créer une annonce') }}
            </x-responsive-nav-link>
